import 'package:appcook/Screens/CategoriesScreen.dart';
import 'package:appcook/Screens/FirstHomeScreen.dart';
import 'package:appcook/Screens/MealScreen.dart';
import 'package:appcook/Screens/ProfileScreen.dart';
    ...
    return Scaffold(
      body: PageView(
        ...
        children: [
          ...
          ProfileScreen(username: widget.accountName,email: widget.accountEmail,),
        ],
        onPageChanged: (index) {
          setState(() {
            _currentIndex = index;
